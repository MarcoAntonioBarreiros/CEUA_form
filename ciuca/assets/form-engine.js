  ...
  <div class="wrap">
    ...
    <section class="step card" data-step="3">
      ...
      <div class="grid g4" style="margin-top:12px">
        ...
        <div><label class="lbl">CPF do RT</label><input id="rtCpf" class="fi" placeholder="000.000.000-00" inputmode="numeric" maxlength="14" oninput="maskCpf(this)"></div>
